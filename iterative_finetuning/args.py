...
def parse_arguments():
    ...
    # Model and Data
    parser.add_argument("--model_name", type=str, default="EleutherAI/gpt-neo-125m", choices = ["EleutherAI/gpt-neo-125m","openai-community/gpt2", "openai-community/gpt2-medium", "openai-community/gpt2-large"] )
    ...
    parser.add_argument("--use_generate", type=int, default=1)
    # Logging and Saving
